...
Version  : 0.9.0
Release  : 66
URL      : https://files.pythonhosted.org/packages/2e/71/c8b405aea2f2abbcd1babc3e3481a64c030aa5bacc8e5ad8d68974e51c8c/nbsphinx-0.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2e/71/c8b405aea2f2abbcd1babc3e3481a64c030aa5bacc8e5ad8d68974e51c8c/nbsphinx-0.9.0.tar.gz
...
%prep
%setup -q -n nbsphinx-0.9.0
cd %{_builddir}/nbsphinx-0.9.0
pushd ..
cp -a nbsphinx-0.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678720617
