...
Source0  : https://files.pythonhosted.org/packages/8d/84/cb762ec2463d41c5bd9370bdeeab56153c363b232ff69f5dea2bf032a889/nbsphinx-0.9.4.tar.gz
...
%prep
%setup -q -n nbsphinx-0.9.4
cd %{_builddir}/nbsphinx-0.9.4
pushd ..
cp -a nbsphinx-0.9.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715030275
