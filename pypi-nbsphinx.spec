...
Source0  : https://files.pythonhosted.org/packages/62/38/6f6a0f9115b493af9d69b68335945827dd46e09de8ef525d1f58cd0870dc/nbsphinx-0.9.6.tar.gz
...
%prep
%setup -q -n nbsphinx-0.9.6
cd %{_builddir}/nbsphinx-0.9.6
pushd ..
cp -a nbsphinx-0.9.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735071522
